...
# Directly import macro_by_month because large all-site raw data to big to import
macro_by_month <- read_csv(here("data", "processed", "macro_by_month.csv"))
...
ggplot() +
  geom_point(data = fish_by_month, aes(x=sample_month, y=unique_taxa, colour = "Fish"))+
  geom_point(data = macro_by_month, aes(x=sample_month, y=unique_taxa, colour = "Macroinvertebrates"))+
  theme_bw()+
  labs(x = "Month",
