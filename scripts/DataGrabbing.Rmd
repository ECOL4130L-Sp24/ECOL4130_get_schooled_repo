...
Extract the siteID for NEON sites that had any fish data available
```{r}
...
Note that only sites that had fish data available ("fish_sites") are included in the data pull
```{r}
